...
export function CollectionForm({ defaults = {}, categories, showCategoryMapping = true, showFeatured = true }: { defaults?: Defaults; categories: Array<{ id: string; path: string }>; showCategoryMapping?: boolean; showFeatured?: boolean }) {
