...
export default async function ClientsPage({ searchParams }: { searchParams: Promise<{ q?: string; status?: string }> }) {
  ...
  return (
    <>
      <PageHeading title="Clientes" description="Empresas com acesso à área comercial." actions={<Button render={<Link href="/admin/clientes/novo" />}><Plus /> Novo cliente</Button>} />
