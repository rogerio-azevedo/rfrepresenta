...
export default async function AdminDashboardPage() {
  ...
  return (
    <>
      <PageHeading title="Visão geral" description="Acompanhe a base de clientes e os acessos ao catálogo." actions={<Button render={<Link href="/admin/clientes/novo" />}>Novo cliente</Button>} />
      ...
      <section className="mt-8">
        <div className="mb-3 flex items-center justify-between"><h2 className="text-base font-semibold">Clientes recentes</h2><Button variant="ghost" render={<Link href="/admin/clientes" />}>Ver todos <ArrowRight /></Button></div>
